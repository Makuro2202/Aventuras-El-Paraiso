...
print("\n***************************************")
print("1. print all 'gta' table entries\n")
...
print("\n***************************************")
print("2. select rows where city = Liberty city\n")
print(gta_search)
...
# combine data from 2 tables and manipulate it with Python
print("\n***************************************")
print("3. print manipulated rows from 'cities' and 'gta' tables\n")
for i in gta_search:
